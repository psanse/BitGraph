...
TEST_F(CliqueCommonTest, find_clique_2) {
	...
	typename ugraph::vertex_bitset_t bb{ ug.size(), {2, 3, 4, 5}};
	std::vector<int> clq;
...
TEST_F(CliqueCommonTest, is_iset) {
	...
	typename ugraph::vertex_bitset_t bb{ ug.size(), { 1, 3, 4} };
...
TEST_F(CliqueCommonTest, is_clique) {
	...
	typename ugraph::vertex_bitset_t bb{ ug.size(), { 0, 4 } };
...
TEST(Clique, find_clique_max_deg) {
	...
	std::vector<int> clq;
	typename ugraph::vertex_bitset_t bbsg{ ug.size(), { 0, 1, 2, 3, 4, 5} };
